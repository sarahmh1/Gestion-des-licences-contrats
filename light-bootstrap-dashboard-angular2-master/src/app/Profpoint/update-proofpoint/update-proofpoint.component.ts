  ...
  private getCommandePasserParValue(value: any): CommandePasserPar {
   ...
   onFileSelected(event: any): void {
     ...
     if (file) {
       ...
       // Upload imm�diatement le fichier
   ...
   loadProofpoint(id: number): void {
     this.proofpointService.getProofpointById(id).subscribe(
       ...
       error => {
         console.error('Erreur r�cup�ration Proofpoint:', error);
       }
     );
   }
     ...
     if (!this.updateForm.valid) {
      ...
      return;
       ...
       this.proofpointService.updateProofpoint(updatedProofpoint).subscribe(
         () => {
           console.log('Proofpoint mis � jour avec succ�s');
           this.router.navigate(['/Afficherproof']);
         },
         error => {
           console.error('Erreur mise � jour Proofpoint:', error);
         }
       );
